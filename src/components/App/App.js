...
function getLoginView(props) {
	return (
		<header className="universe">
			<div className="decorative-drawer">
				<LogoWithTitle />
			</div>
...
function getMainContent(props) {
	if (!props.isLoggedIn) {
		return getLoginView(props)
	}

	return getActualApp(props)
}

export default function App(props) {
	const MainContent = getMainContent(props)
